...
namespace WebApp_1._44_PracticeProject.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(Db1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Subject != null ? 
                          ...
                          Problem("Entity set 'Db1Context.Subject'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,SubjectId")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,SubjectId")] Subject subject)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Db1Context.Subject'  is null.");
            }
            var subject = await _context.Subject.FindAsync(id);
            if (subject != null)
            {
